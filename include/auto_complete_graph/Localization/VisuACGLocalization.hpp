...
class VisuAutoCompleteGraphLocalization
    : public VisuAutoCompleteGraphBase<AutoCompleteGraphPriorXY,
                                       g2o::VertexXYPrior,
                                       g2o::EdgeXYPriorACG> {
   protected:
   ...
   public:
    VisuAutoCompleteGraphLocalization(
        ...
        _last_seen_landmark_in_mcl_pose.type =
            ...
            for (auto ite2 = (*it)->vertices().begin();
                ...
                if (ptr != NULL) {
                    ...
                    throw std::runtime_error(
                        "Links do not have the good vertex type");
                }
...
inline void VisuAutoCompleteGraphLocalization::drawCorrectRobotPoses(
    const AutoCompleteGraphLocalization& acg) {
...
inline void VisuAutoCompleteGraphLocalization::drawPriorObservations(
    const AutoCompleteGraphLocalization& acg) {
...
inline void VisuAutoCompleteGraphLocalization::drawMCL(
    const AutoCompleteGraphLocalization& acg) {
...
inline void VisuAutoCompleteGraphLocalization::drawMCLAngles(
    const AutoCompleteGraphLocalization& acg) {
...
template <>
inline void AASS::acg::VisuAutoCompleteGraphBase<AutoCompleteGraphPriorXY,
                                                 g2o::VertexXYPrior,
                                                 g2o::EdgeXYPriorACG>::
    drawPrior(
        const AASS::acg::AutoCompleteGraphBase<AutoCompleteGraphPriorXY,
                                               g2o::VertexXYPrior,
...
inline void VisuAutoCompleteGraphLocalization::drawNDTCellObservations(
    const AutoCompleteGraphLocalization& acg) {
    ...
    for (auto edge : edges) {
        for (auto ite2 = edge->vertices().begin();
             ite2 != edge->vertices().end(); ++ite2) {
            geometry_msgs::Point p;
...
inline void VisuAutoCompleteGraphLocalization::drawNDTCellAssociations(
    const AutoCompleteGraphLocalization& acg) {
...
inline void VisuAutoCompleteGraphLocalization::drawNDTCellsMCL(
    const AutoCompleteGraphLocalization& acg) {
    ...
    for (auto edge : acg.getNDTCellObservations()) {
        ...
        g2o::VertexSE2RobotLocalization* cell =
            dynamic_cast<g2o::VertexSE2RobotLocalization*>(edge->vertices()[0]);
        if (cell != NULL) {
            cell_robot = cell;
            ...
            ;
            cell_robot = dynamic_cast<g2o::VertexSE2RobotLocalization*>(
                edge->vertices()[1]);
            assert(cell_node != NULL);
